...
export const toolRegistry: ToolMeta[] = [
  ...
  },
  {
    ...
    name: '计时器',
    nameEn: 'Timer',
    description: '正计时与倒计时工具',
    category: 'datetime',
    tags: ['timer', 'countdown', 'stopwatch', '计时', '倒计时'],
    keywords: ['计时器', '倒计时', '正计时', 'stopwatch', 'countdown'],
    icon: 'Hourglass',
  },
...

  {
    id: 'grid-generator',
    name: 'CSS Grid 生成器',
    nameEn: 'CSS Grid Generator',
    description: '可视化grid-template，拖拽布局，复制CSS',
    category: 'color',
  ...
  },
  {
    ...
    name: '图标搜索',
    nameEn: 'Icon Search',
    description: 'Lucide/Heroicons/Tabler图标搜索，一键复制',
    category: 'color',
  ...
  },
  {
    id: 'animation-gen',
    name: 'CSS 动画生成',
    nameEn: 'CSS Animation Generator',
    description: '可视化配置@keyframes/transition，实时预览',
    category: 'color',
  ...
  },
  {
    ...
    name: '字体搭配',
    nameEn: 'Font Pairing',
    description: 'Google Fonts搜索+搭配预览，复制HTML/CSS',
    category: 'color',
  ...
  },
  {
    ...
    description: 'URL列表→XML Sitemap，支持优先级设置',
    category: 'devops',
  ...
  },
  {
    ...
    description: '可视化配置robots.txt，支持规则预览',
    category: 'devops',
  ...
  },
  {
    id: 'htaccess-gen',
    name: '.htaccess 生成',
    nameEn: '.htaccess Generator',
    description: '重定向/缓存/安全头规则生成',
    category: 'devops',
  ...
  },
  {
    id: 'tool-compare',
    name: '工具对比模式',
    nameEn: 'Tool Compare Mode',
    description: '同一输入同时用多个工具处理，对比结果',
    category: 'text',
